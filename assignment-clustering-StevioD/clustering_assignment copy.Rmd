...
```
Each cluster seems to have a majority of their people live in the western Washington Metro area. The next most popular area to live in is Thurston. This is constant across all clusters. Cluster 2 has the greatest population of 950 and Cluster 3 has a population of 674. 
...
```
For this section, I wondered if five different clusters would be better than three, so I clustered the data into five groups. In cluster 1, We see a mean customer age of 43.65, an average account age of 12.24 years, who's most predominant region is the W WA Metro area. This clusters most common focal value is Education. They also scored a mean score of 3.08 on greater public priv, a mean score of 4.0 on experience and a mean score of 4.53 on if teachers are underpaid. 

Cluster 2 has a mean age of 49.26, mean account age of 14.22 years, and are predominately located in the W WA Metro. Their most common focal value is the environment. This clusters mean score for greater public priv was 3.37, their mean score for experience was 3.87 and their mean score for underpaid teachers was 5.31. 

Cluster 3 had a mean age of 53, a mean account age of 14.91 years, and are also located mostly in the W WA Metro with Thurston being a close second (254 and 215 respectively). These people are mostly interested in Education, Health, and Hunger and Poverty (120, 105, 107). They rank third in greater public priv with a mean score of 3.24, 4th in experience with a mean score of 3.97, and second in underpaid teachers with a mean score of 5.04.

Cluster 4 is our oldest group, with an average age of 55.07, they have held their accounts on average 13.1 years, and primarily live in the W WA Metro and Thurston area (152 and 140). Their primary focal interest is health with 78 votes, and education with 76. They have a mean greater public priv score of 3.29, a mean score for experience of 4.14, and a mean underpaid teacher score of 4.91.

Cluster 5 has mean age of 52.04, mean account age of 14.12, and primarily live in W WA Metro and Thurston (65 and 61). This cluster cares about health and law enforcement with 50 and 45 votes each. They have the lowest score of greater public priv with an average score of 2.58. This cluster values experience the most with and average score of 4.18 and they scored on average the lowest for underpaid teachers with mean score of 4.05. 
